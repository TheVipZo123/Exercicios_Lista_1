...
//#endif
	...
	GLfloat colorTriangle1[] = { 1.0f, 0.0f, 0.0f, 1.0f }; // Vermelho
	GLfloat colorTriangle2[] = { 0.0f, 1.0f, 0.0f, 1.0f }; // Verde
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4fv(colorLoc, 1, colorTriangle2); //enviando cor para variável uniform inputColor
		//shader.setVec4("inputColor", 0.0f, 0.0f, 1.0f, 1.0f);
		glDrawArrays(GL_LINE_LOOP, 0, 3);
		//glUniform4fv(colorLoc, 1, colorTriangle1);
